...
public class ChangeGenderDialog extends DialogFragment {
    ...
    private View v;
    private ChangeEmailDialog.EmailChangeCallback changedEmailChangeCallback;
    ...
    public void onAttach(@NonNull @NotNull Context context) {
        ...
        try {
            changedEmailChangeCallback =(ChangeEmailDialog.EmailChangeCallback) getTargetFragment();
        }catch (Exception e) {
