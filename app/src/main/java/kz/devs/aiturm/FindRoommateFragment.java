 ...
 public class FindRoommateFragment extends Fragment {
    ...
    private RefreshProgressBarDialogFragment refreshProgressBarDialogFragment;
...
//    }
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()){
                    ...
                    case 3:
                        ...
                        recyclerView.setVisibility(View.GONE);
                        fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.frame_layout_search, new UserSearchFragment());
                ...
                if (!recyclerView.canScrollVertically(1)) {
                    ...
                    if (searchState) {
                        ...
                        if (searchUserId != null) {
                            refreshProgressBarDialogFragment = new RefreshProgressBarDialogFragment();
                            refreshProgressBarDialogFragment.show(getParentFragmentManager(), null);
    ...
    void getUsersFromQuery(String query){
        ...
        FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.frame_layout_search, userSearchFragment).commit();
...
//         query = query.orderBy("time_stamp", Query.Direction.ASCENDING);
     ...
     void closeProgressBarsSetOverPullListener(){
        ...
        if(refreshProgressBarDialogFragment !=null){
            refreshProgressBarDialogFragment.dismiss();
        }
    }
